...
export const Selecteditem = () => {
  ...
  const sendCartItemsToDatabase = () => {
    ...
    axios.post('http://localhost/WDPF/react/wedding-solutions/API/ordersubmit.php', payload)
      .then(response => {
  ...
  return (
    <>
      <div className="container">
            ...
            <div class="col-md-6 mb-3">
              <div class="card h-100">
                ...
                <div class="card-footer text-center">
                  <button className="btn btn-outline-danger" type="button" onClick={() => deleteItemFromLocalStorage('scartItems', product.id)}>
                    Delete
                  </button>
                </div>
              </div>
        ...
        <div className="row">
          <div className="fs-2 fw-bold fnt2 text-center my-3">Selected Gate Items</div>
        ...
        <div className="row">
          <div className="fs-2 fw-bold fnt2 text-center my-3">Selected Hall Items</div>
        ...
        <div className="row">
          <div className="fs-2 fw-bold fnt2 text-center my-3">Selected Photoshoot Items</div>
        ...
        {
          isLogin && <div className="fs-2 fw-bold fnt2 text-center my-3">
          <button className='btn btn-outline-dark fs-2 mx-auto' type="button" onClick={sendCartItemsToDatabase}>Submit Data</button>
          </div>
        }
        {
          !isLogin && 
          <div className="fs-2 fw-bold fnt2 text-center my-3">Please <Link to='/login'>LogIn</Link> to Submit Your Choice</div>
        }
      </div>
